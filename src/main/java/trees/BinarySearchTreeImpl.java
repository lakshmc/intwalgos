 ...
 */
public class BinarySearchTreeImpl <T extends Comparable<T>> implements Iterable<T>
{
    public static void main(String[] args)
    {
        ...
        System.out.println("After inserting initial set of numbers");
        ...
        bst = new BinarySearchTreeImpl<Integer>(new IntegerComparator());
        for(Integer n : a) bst.insert(n);

        System.out.println("After inserting with custom comparator initial set of numbers");
        bst.preOrderTraversal();
        System.out.println();
        ...
        System.out.println("Printing BST by iterating with For loop");
        for(Integer n : bst) System.out.print(n);
        System.out.println();

        System.out.println("Printing BST using sout");
        System.out.println(bst);

        //testing restoring a tree from two given traversals
        System.out.println("Building BST from two traversal results");
    ...
    public BinarySearchTreeImpl(Comparator<T> comp)
    {
        root = null;
        comparator = comp;
    }
    ...
    public BinarySearchTreeImpl<T> clone()
    {
        BinarySearchTreeImpl<T> twin = null;

        if(comparator == null)
            twin = new BinarySearchTreeImpl<T>();
        else
            twin = new BinarySearchTreeImpl<T>(comparator);
...
}//end of BinarySearchTreeImpl

class IntegerComparator implements Comparator<Integer>
{
    public int compare(Integer x, Integer y)
    {
        //return x-y; // asc order
        return y-x; // desc order
    }
}